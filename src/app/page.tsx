...
const CODE_LINES = [
  ...
  [
    { text: '    "cofounder"', color: "#79c0ff" },
    { text: ':  "', color: "#e6edf3" },
    { text: "Keytrus", color: "#a5d6ff" },
    { text: '",', color: "#e6edf3" },
  ],
  [
...
const OUTPUT_LINES: { text: string; color: string; bold?: boolean; pulse?: boolean; size?: string; href?: string; iconSrc?: string; type?: "image"; src?: string }[] = [
  ...
  { text: " Co-founder, Keytrus — property management platform",      color: "#79c0ff", size: "text-sm leading-relaxed" },
  { text: "",                                                          color: "" },
  { text: " Computer Engineering graduate of the University of",      color: "#8b949e" },
  { text: " Saskatchewan (June 2026). I build across the full",       color: "#8b949e" },
  { text: " stack — from web apps to real-time embedded systems",     color: "#8b949e" },
  { text: " on Raspberry Pi and FPGA.",                                color: "#8b949e" },
  { text: "",                                                          color: "" },
  { text: " Co-founded Keytrus, a multi-tenant property",             color: "#8b949e" },
  { text: " management SaaS — Next.js, Postgres Row-Level",           color: "#8b949e" },
  { text: " Security, deployed live on Vercel.",                      color: "#8b949e" },
  { text: "",                                                          color: "" },
