...
const OUTPUT_LINES: { text: string; color: string; bold?: boolean; pulse?: boolean; size?: string; href?: string; iconSrc?: string; type?: "image"; src?: string }[] = [
  ...
  { text: " Co-founder, Keyhold — property management platform",      color: "#79c0ff", size: "text-sm leading-relaxed" },
  { text: "",                                                          color: "" },
  ...
  { text: "",                                                          color: "" },
  { text: " Co-founded Keyhold, a multi-tenant property",             color: "#8b949e" },
